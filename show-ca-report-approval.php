	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">CA Report Approval Supervisor</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">CA Report Approval Supervisor</h1>
			</div>
		</div><!--/.row-->
					...
					<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" >
						 ...
						 <thead>
							...
							<th data-field="itemid" data-sortable="true">No</th>
								...
								<th data-field="status_ca_report_approval" data-sortable="true">Status CA Report SPV</th>
...
?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-ca-report-approval.php?id=<?php echo $record['id_ca_request'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;<a href="ubah-ca-report-approval.php?id=<?php echo $record['id_ca_request'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a>&nbsp;&nbsp;<a href="all-detail-ca-request.php?id=<?php echo $record['id_ca_request'];?>"><span class="glyphicon glyphicon-tasks" title="Detail CA Report"></a></td>
...
$sql_closed = "select ca_request.id_ca_request, ca_request.swos, ca_request.tgl_request, ca_request.tgl_approve, ca_request.judul_ca, ca_request.jumlah, ca_request.jumlah_sisa_ca, engineer.nama_engineer, ca_request.status_approval, ca_request.status_ca_report_approval from ca_request,engineer where ca_request.id_engineer=engineer.id_engineer and status_ca_report_approval='Approved' order by id_ca_request desc";
...
?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-ca-report-approval.php?id=<?php echo $ticket_close['id_ca_request'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;<a href="ubah-ca-report-approval.php?id=<?php echo $ticket_close['id_ca_request'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a>&nbsp;&nbsp;<a href="all-detail-ca-request.php?id=<?php echo $ticket_close['id_ca_request'];?>"><span class="glyphicon glyphicon-tasks" title="Detail CA Report"></a></td>
