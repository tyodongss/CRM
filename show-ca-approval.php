...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">CA Approval</h1>
			</div>
		</div><!--/.row-->
		...
		$sql = "select ca_request.id_ca_request, ca_request.swos, ca_request.tgl_request, ca_request.tgl_approve, ca_request.judul_ca, ca_request.jumlah, engineer.nama_engineer, ca_request.status_approval, ca_request.status_ca_request from ca_request,engineer where ca_request.id_engineer=engineer.id_engineer and ca_request.status_approval='Need Approval' order by id_ca_request desc";
...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#needapproval">Need Approval</a></li>
...
?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-ca-approval.php?id=<?php echo $record['id_ca_request'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-ca-request-approval.php?id=<?php echo $record['id_ca_request'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a></td>
...
$sql_closed = "select ca_request.id_ca_request, ca_request.swos, ca_request.tgl_request, ca_request.tgl_approve, ca_request.judul_ca, ca_request.jumlah, engineer.nama_engineer, ca_request.status_approval, ca_request.status_ca_request from ca_request,engineer where ca_request.id_engineer=engineer.id_engineer and ca_request.status_approval='Approved' order by id_ca_request desc";
...
?>
								...
								<td data-field="status_ca_request" data-sortable="true">
						        <?php if($ticket_close['statusca_request'] == 'Open') { ?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-ca-approval.php?id=<?php echo $ticket_close['id_ca_request'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-ca-request-approval.php?id=<?php echo $ticket_close['id_ca_request'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a></td>
