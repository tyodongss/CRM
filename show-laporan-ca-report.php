...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan CA Report</h1>
            </div>
        </div><!--/.row-->
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            ...
                            <form id="someForm2" action="" method="POST">
								...
								<div class="form-group">
									<label>Pilih CA Request</label>
									<select class="form-control" name="id_ca_request" required>
									<option>---- Pilih CA Request ----</option>
									<?php
									include "koneksi.php";
									$sql = mysql_query("SELECT * FROM ca_request order by judul_ca asc");
								...
								<div class="help-block with-errors"></div>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-ca-report.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-ca-report.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
