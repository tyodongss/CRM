...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan SLA Customer</h1>
            </div>
        </div><!--/.row-->
         ...
         <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <!--<div class="panel-heading">SLA Customer</div>-->
          ...
          ?>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-sla-customer.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-sla-customer.php";
                                            form.submit();
                                    }
                                    </script>
