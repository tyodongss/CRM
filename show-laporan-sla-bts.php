...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan SLA BTS</h1>
            </div>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <!--<div class="panel-heading">SLA BTS</div>-->
                    ...
                    <span class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="nama_bts" required>
                                    ...
                                    echo '<option value="'.$data['nama_bts'].'">'.$data['nama_bts'].'</option>';
                                        }
                                    }
                                    ?>
                                </select>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-sla-bts.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-sla-bts.php";
                                            form.submit();
                                    }
                                    </script>                             
