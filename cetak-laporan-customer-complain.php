...
<?php include "menu-user.php" ?>
    ...
    <div class="row">
      ...
      <?php
            ...
            $sql = "SELECT customer_complain.id_customer_complain, customer_complain.swos, customer_complain.id_customer, customer_complain.status_charge, customer_complain.nama_cust_complain, customer_complain.complain_via, customer_complain.priority_complain, customer_complain.datetime_start, customer_complain.datetime_end, customer_complain.root_cause, customer_complain.solved_after, customer_complain.status_cust_complain, customer.nama FROM customer_complain JOIN customer ON customer_complain.id_customer = customer.id_customer WHERE status_charge =  'Charge' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' ORDER BY id_customer_complain desc";

} else if ($status_charge=="Free"){

            $sql = "SELECT customer_complain.id_customer_complain, customer_complain.swos, customer_complain.id_customer, customer_complain.status_charge, customer_complain.nama_cust_complain, customer_complain.complain_via, customer_complain.priority_complain, customer_complain.datetime_start, customer_complain.datetime_end, customer_complain.root_cause, customer_complain.solved_after, customer_complain.status_cust_complain, customer.nama FROM customer_complain JOIN customer ON customer_complain.id_customer = customer.id_customer WHERE status_charge =  'Free' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' ORDER BY id_customer_complain desc";

} else if ($status_charge=="All"){

            $sql = "SELECT customer_complain.id_customer_complain, customer_complain.swos, customer_complain.id_customer, customer_complain.status_charge, customer_complain.nama_cust_complain, customer_complain.complain_via, customer_complain.priority_complain, customer_complain.datetime_start, customer_complain.datetime_end, customer_complain.root_cause, customer_complain.solved_after, customer_complain.status_cust_complain, customer.nama FROM customer_complain JOIN customer ON customer_complain.id_customer = customer.id_customer WHERE datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' ORDER BY id_customer_complain desc";   
} else {

            $sql = "SELECT customer_complain.id_customer_complain, customer_complain.swos, customer_complain.id_customer, customer_complain.status_charge, customer_complain.nama_cust_complain, customer_complain.complain_via, customer_complain.priority_complain, customer_complain.datetime_start, customer_complain.root_cause, customer_complain.solved_after, customer_complain.datetime_end, customer_complain.status_cust_complain, customer.nama FROM customer_complain join customer on customer_complain.id_customer=customer.id_customer WHERE datetime_start='$tgl' ORDER BY id_customer_complain desc";
            }
