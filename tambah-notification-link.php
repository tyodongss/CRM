...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Create Link Notification</h1>
			</div>
		</div><!--/.row-->
...
<div class="form-group">
<label>Date/Time Start</label><i> all time is set to GMT+8</i>
<input type="text" name="start" class="form-control" required value="<?php print date('l, F, d, Y, G:i')?>">
</div>

<div class="form-group">
<label>Coverage</label>
<textarea class="span4 form-control" name="coverage">
</textarea>

<div class="form-group">
<label>Status</label>
<input type="text" name="status" class="form-control" readonly value="Investigate">
</div>
...
<option> </option>
<option value="savedb">Save Database</option>
<option value="email">Save Database & Email</option>
</select>
</div>

<input type="hidden" name="createby" value="<?php print $_SESSION['nama_engineer']?>">
<input type="hidden" name="category" value="Link Notification">
<input type="hidden" name="menu" value="notiflink">
