...
?> 		
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form data-toggle="validator" role="form" action="update-barang-update.php" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="tgl_barang_update" value="<?php echo $row['tgl_barang_update'];?>">
                <div class="help-block with-errors"></div>
            </div>
        ...
        <div class="form-group">
          ...
          <option selected value="<?php echo $row['status_rma'];?>"><?php echo $row['status_rma'];?></option>
              ...
              <option>selesai RMA</option>
								...
								<a href="../show-barang-update.php" class="btn btn-default">Back</a>
<?php
}
?>	
							</div>
