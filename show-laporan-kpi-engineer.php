    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">KPI Engineer</li>
            </ol>
        </div><!--/.row-->
        
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan KPI Engineer</h1>
            </div>
        </div><!--/.row-->
...
<?php } ?>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-kpi-engineer.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-kpi-engineer.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
