                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                          <li class="active"><a data-toggle="tab" href="#department">Berdasarkan Department</a></li>
                       ...
                       <form id="someForm" action="" method="POST">
						...
						<div class="form-group">
                                    <label>Owner Barang</label>
                                    <select class="form-control" name="nama_owner" required>
                                    <option>---- Pilih Owner ----</option>
                                    <option>All</option>
                                    <?php
                                    include "koneksi.php";
                                    $sql = mysql_query("SELECT owner.nama_owner FROM barang,owner where barang.id_owner=owner.id_owner group by nama_owner asc");
                                    if(mysql_num_rows($sql) != 0){
                                    while($data = mysql_fetch_assoc($sql)){
                                    echo '<option value="'.$data['nama_owner'].'">'.$data['nama_owner'].'</option>';
                                        }
                                    }
                                    ?>
                                </select>
                  ...
                  function askForLihat() {
                          form.action="cetak-laporan-barang-department.php";
                          form.submit();
                  }
                  function askForDownload() {
                          form.action="export-laporan-barang-department.php";
                          form.submit();
                  }
                  </script>
									</div>
