...
$sql = "SELECT barang_keluar.id_barangKeluar, barang_keluar.bts, barang_keluar.tanggal, barang_keluar.swos,barang_keluar.created_at, barang_keluar.updated_at, barang_keluar.deleted_at, barang.nama_barang, barang.serial_number, customer.nama, engineer.nama_engineer FROM barang_keluar JOIN barang ON barang_keluar.id_barang = barang.id_barang JOIN customer ON barang_keluar.id_customer = customer.id_customer JOIN engineer ON barang_keluar.id_engineer = engineer.id_engineer where status_barang='tidak tersedia' order by id_barangKeluar desc";
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="tambah-barang-keluar.php" class="btn btn-primary btn-md">Tambah Barang Keluar</a></div>
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
						    ...
						    <tr>
						        ...
						        <th data-field="id_customer" data-sortable="true">Nama Customer</th>
...
?>
						   <tr>
						        ...
						        <td data-field="id_engineer" data-sortable="true"><?php echo $record['nama_engineer'];?></td>						        
						       	<td data-field="action" data-sortable="true"><a href="detail-barang-keluar.php?id=<?php echo $record['id_barangKeluar'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-barang-keluar.php?id=<?php echo $record['id_barangKeluar'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;</td>
						    </tr>
<?php
}
?>					    							
