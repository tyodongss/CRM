...
include "koneksi.php"; 
$id=$_GET['id']; 
$query=mysql_query("select ca_request.swos, ca_request.id_ca_budget, ca_budget.judul_ca_budget, ca_request.id_paa, paa.nama_paa, ca_request.tgl_request, ca_request.tgl_approve, ca_request.id_job_to_do, job_to_do2.nama_job_to_do, ca_request.judul_ca, ca_request.keterangan, ca_request.jumlah, ca_request.jumlah_sisa_ca, ca_request.id_engineer, engineer.nama_engineer,  ca_request.status_approval, ca_request.status_ca_request, ca_request.status_ca_report_confirm, ca_request.status_ca_report_approval, ca_request.created_at, ca_request.updated_at, ca_request.deleted_at from ca_request, ca_budget, paa, engineer, job_to_do2 where ca_request.id_ca_budget=ca_budget.id_ca_budget and ca_request.id_paa=paa.id_paa and ca_request.id_engineer=engineer.id_engineer and ca_request.id_job_to_do=job_to_do2.id_job_to_do and id_ca_request='$id'"); 
?> 
<?php 
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="update-ca-request.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
								...
								<div class="form-group">
									...
									<input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="tgl_approve" value="<?php echo $row['tgl_approve'];?>">									
								</div>
								...
								<div class="form-group">
                                  ...
                                  <select class = "form-control" name="status_ca_request" >
                                  <option selected value="<?php echo $row['status_ca_request'];?>"><?php echo $row['status_ca_request'];?></option>
                                  <?php									
								  $status_ca_report_approval = $row['status_ca_report_approval'];
								  
								  if ($_SESSION['role']!="paa" && $status_ca_report_approval !="Approved") {
									  echo '<option value="---- Pilih Status ----" >---- Pilih Status ----</option>';
								...
								<div class="form-group">									
									<input class="form-control" type="hidden" name="status_ca_report_confirm" value="<?php echo $row['status_ca_report_confirm'];?>">
								</div>
