...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tambah Domain</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form data-toggle="validator" role="form" action="proses-domain.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">

								<div class="form-group">
									<label>Nama Domain</label>
									<input class="form-control" name="nama_domain" value="" required>
								...
								<div class="form-group">
                                    ...
                                    <select class="form-control" name="id_registrar" required>
								...
								<div class="form-group">
									...
									<input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="date_register" value="">
									<div class="help-block with-errors"></div>
								</div>
								
								<div class="form-group">
									<label>Date Expire</label>
									<input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="date_expire" value="">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="webhosting_usage" value="" maxlength="25">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="mailhosting_usage" value="" maxlength="25">
								</div>
								...
								<div class="form-group">
									...
									<option>Mail Hosting Only</option>
									<option>Web Hosting Only</option>
									<option>Web & Mail Hosting</option>
                                    </select>
                                </div>
								
								<div class="form-group">
									<label>Nama Kontak</label>
									<input class="form-control" name="nama_kontak" value="" maxlength="35">
								</div>
								
								<div class="form-group">
									<label>No. HP Kontak</label>
									<input class="form-control" name="hp_kontak" value="" maxlength="35">
								</div>
								
								<div class="form-group">
									<label>Email Kontak</label>
									<input class="form-control" name="email_kontak" value="" maxlength="50">
								</div>
