      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6">
				<form data-toggle="validator" role="form" action="process-item.php" method="post">
				...
				<div class="form-group">
					<label>Type</label><br>
					<select class="selectpicker" name="id_type" data-live-search="true" data-width="100%">
				...
				<div class="form-group">
					...
					<select class="selectpicker" name="id_model" data-live-search="true" data-width="100%">
				...
				<div class="form-group">
					...
					<option selected>S-Net Indonesia</option>
					<option>Other</option>
					</select>
                </div>
				...
				<div class="form-group">
					...
					<input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="date_purchase" value="">                  
                </div>
				...
				<div class="form-group">
					...
					<option selected>Contracted</option>
				...
				<div class="form-group">
					...
					<input class="form-control" name="ip_address" value="">
                </div>  
