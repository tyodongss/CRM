...
<?php include "menu-user.php" ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Tambah Job To Do Update</h1>
      </div>
    </div><!--/.row-->
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <form data-toggle="validator" role="form" action="proses-job-to-do-update.php" method="post">
              <input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">

                    <div class="form-group">
				                <label for="id_job_to_do">Job ID</label>
				                <input class="form-control" name="id_job_to_do" id="id_job_to_do">
				            </div>

				            <div class="form-group">
				                <label for="nama_job_to_do">Judul Job To Do</label>
				                <input class="form-control" name="nama_job_to_do" id="nama_job_to_do">
				            </div>

                     <div class="form-group">
                        <input class="form-control" type="hidden" id="id_owner">
                    </div>

                    <div class="form-group">
                        <input class="form-control" name="email_owner" type="hidden" id="email_owner">
                    </div>
								...
								<div class="help-block with-errors"></div>
								  ...
								  <div class="form-group">
									<label>Date Time Update</label>
										<input class="form-control" name="tgl_update" type="datetime" value="<?php print date('Y-m-d G:i:s'); ?>">
								</div>
  ...
  <script>
            $(function() {
                $( "#id_job_to_do" ).autocomplete({
                    source: "namaJobToDo.php",
                    minLength: 1,
                    select: function( event, ui ) {
              $('#nama_job_to_do').val(ui.item.nama_job_to_do);
              $('#id_owner').val( ui.item.id_owner);
              $('#email_owner').val( ui.item.email_owner);
                    }
                });
            });
        </script> 
