...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Edit Engineer</h1>
			</div>
		</div><!--/.row-->
<?php 
include "koneksi.php"; 
						...
						<div class="col-md-6">
							...
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
								...
								<div class="form-group">
									...
									<input class="form-control" name="name_engineer" value="<?php echo $row['name_engineer'];?>">
								</div>
								
								<div class="form-group">
									<label>Email Engineer</label>
									<input class="form-control" name="email_engineer" value="<?php echo $row['email_engineer'];?>">
								</div>
