	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">History BTS Problem</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">History BTS Problem</h1>
			</div>
		</div><!--/.row-->
		...
		$sql = "select bts_problem.id_bts_problem,bts_problem.swos,device_bts.nama_device,bts_problem.description,bts_problem.datetime_start,bts_problem.datetime_end, bts_problem.status_bts_problem, bts_problem.deleted_at from bts_problem,device_bts where device_bts.id_device_bts=bts_problem.id_device_bts and bts_problem.deleted_at is not NULL order by id_bts_problem DESC";
...
?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-bts-problem.php?id=<?php echo $record['id_bts_problem'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;</td>
