			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form data-toggle="validator" role="form" action="proses-history-backbone-problem.php" method="post">
...
<div class="form-group">
	...
	<?php
	include "koneksi.php";
	$sql = mysql_query("select * from circuit where status_circuit='Active' order by id_circuit asc");
