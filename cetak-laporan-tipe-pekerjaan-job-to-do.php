...
<?php include "menu-user.php" ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <center><h1 class="page-header">Laporan Job to Do Tipe Pekerjaan</h1></center>
      ...
      <?php
            ...
            } else if ($tipe_pekerjaan="$tipe_pekerjaan") {
             $sql = "SELECT job_to_do2.swos, job_to_do2.id_owner, owner.nama_owner, job_to_do2.datetime_open, job_to_do2.datetime_finish, job_to_do2.tipe_pekerjaan, job_to_do2.priority_pekerjaan, job_to_do2.scope_pekerjaan, job_to_do2.keterangan_pekerjaan, job_to_do2.status_charge, job_to_do2.status_jobtodo, job_to_do2.created_at, job_to_do2.updated_at, job_to_do2.deleted_at, customer.nama, terima_pekerjaan.nama_terima_pekerjaan, detail_pekerjaan.nama_detail_pekerjaan, timediff(job_to_do2.datetime_finish, job_to_do2.datetime_open) as duration, job_to_do2.remark
               FROM job_to_do2
               JOIN customer ON job_to_do2.id_customer = customer.id_customer
               JOIN terima_pekerjaan ON job_to_do2.id_terima_pekerjaan = terima_pekerjaan.id_terima_pekerjaan
               JOIN detail_pekerjaan ON job_to_do2.id_detail_pekerjaan = detail_pekerjaan.id_detail_pekerjaan
               JOIN owner ON job_to_do2.id_owner = owner.id_owner
               AND tipe_pekerjaan = '$tipe_pekerjaan'
			   AND datetime_open
               BETWEEN  '$tgl_awal4'
               AND  '$tgl_akhir4'
               ORDER BY job_to_do2.id_job_to_do DESC";
            ...
            <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="false" data-show-toggle="false" data-show-columns="false" data-search="false" data-select-item-name="toolbar1" data-pagination="false" >
                            ...
                            <tr>
                                ...
                                <th data-field="id_owner"  data-filter-control="input">id_Owner</th>
...
?>
                           <tr>
                                ...
                                <td data-field="id_owner" data-sortable="true"><?php echo $record['id_owner'];?></td>
...
?>  
      ...
      <?php
      if ($tipe_pekerjaan=="$tipe_pekerjaan"){
      $sql3 = mysql_query("SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(timediff(datetime_finish,datetime_open)))) as total, tipe_pekerjaan, COUNT( * ) AS total_tipe_pekerjaan2
                from job_to_do2
                where tipe_pekerjaan =  '$tipe_pekerjaan'
                AND datetime_open
                BETWEEN  '$tgl_awal4'
                AND  '$tgl_akhir4'");
        }
      ...
      <table class="table"> 
              <thead>
                <tr>
                  <td width="20%" data-field="total" data-sortable="true"><b>Total Duration</b></td>
                      <?php while($record4 = mysql_fetch_array($sql3)){ ?>
                      <td><?php echo $record4['total'];?></td>
                </tr>

                 <tr>
                  <td width="20%" data-field="total_tipe_pekerjaan2" data-sortable="true"><b>Jumlah Tipe Pekerjaan</b></td>
                      <td><?php echo $record4['total_tipe_pekerjaan2'];?></td>
                </tr>
                 ...
                 <tr>
                   ...
                   <tr>
                    <td width="10%"><b>MTTR</b></td>
                    <td> 
                    <?php
                    $total_tipe_pekerjaan2 = $record4['total_tipe_pekerjaan2'];
                    $mttr = $ttr/$total_tipe_pekerjaan2; 
                    echo round($mttr, 2); ?>
                    </td>
                   </tr>
                    <? } ?>
