...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan Domain</h1>
            </div>
        </div><!--/.row-->
                  ...
                  <div class='input-group date' id='datetimepicker2'>
                    ...
                    <span class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="form-group">
                                    <label>Status</label>
                                    <select class="form-control" name="status_domain" required>
                                    <option>---- Pilih Status ----</option>
                                    <option>All</option>
                                    <?php
                                    include "koneksi.php";
                                    $sql = mysql_query("SELECT status_domain FROM domain group by status_domain asc");
                                    if(mysql_num_rows($sql) != 0){
                                    while($data = mysql_fetch_assoc($sql)){
                                    echo '<option value="'.$data['status_domain'].'">'.$data['status_domain'].'</option>';
                                        }
                                    }
                                    ?>
                                </select>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-domain.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-domain.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
