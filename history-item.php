...
<?php include "menu-user.php" ?>
  ...
  <div class="row">
    <div class="col-lg-12">
      <center><h1 class="page-header">History Item</h1></center>
      
      <?php
      include "koneksi.php";
      $id = $_GET['id'];
		  
	  $sql = "SELECT items_update.id_items_update, items.serial_number, items_update.date_update, items_update.purpose, items_update.purpose_name_item, customer.name_customer, engineer.name_engineer
...
?>
                <tr>
				  ...
				  <td data-field="purpose" data-sortable="true"><?php echo $record['purpose'];?></td>
