...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan Backbone Problem</h1>
            </div>
        </div><!--/.row-->
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" name="tgl_akhir" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="nama_circuit" required>
                                    <option selected>All</option>
                                    <?php
                                    include "koneksi.php";
                                    $sql = mysql_query("SELECT * FROM circuit");
                                    if(mysql_num_rows($sql) != 0){
                                    while($data = mysql_fetch_assoc($sql)){
                                    echo '<option value="'.$data['nama_circuit'].'">'.$data['nama_circuit'].'</option>';
                                        }
                                    }
                                    ?>
                                </select>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-backbone-problem.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-backbone-problem.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
