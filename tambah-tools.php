...
<?php include "menu-user.php" ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Tambah Tools</h1>
      </div>
    </div><!--/.row-->
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <form data-toggle="validator" role="form" action="proses-tools.php" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <label>Toolbox</label>
                  <select class="form-control" name="id_toolbox" required>
                  <?php
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="serial_number" value="" maxlength="30">
                  <div class="help-block with-errors"></div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="status_tools" value="tersedia" maxlength="20" required>
                <div class="help-block with-errors"></div>
                </div>
				
				         <div class="form-group">
                  <label>Nilai Perolehan</label>
                  <input class="form-control" name="nilai_perolehan" maxlength="30 "value="0">
                </div>
