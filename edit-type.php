...
include "koneksi.php"; 
$id=$_GET['id']; 
$query=mysql_query("select * from type where id_type='$id'"); 
?> 
<?php 
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="update-type.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
                            <input type="hidden" name="id" value="<?php echo $id;?>"/>
								<div class="form-group">
									<label>Type Name</label>
									<input class="form-control" name="name_type" value="<?php echo $row['name_type'];?>">
								</div>
										
								<button type="submit" class="btn btn-primary">Update</button>
								<a href="../show-type.php" class="btn btn-default">Back</a>
<?php
}
?>	
							</div>
