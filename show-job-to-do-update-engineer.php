		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="add-job-to-do-update-engineer.php" class="btn btn-primary btn-md">Add New Job To Do Update</a></div>
...
?>
							<tr>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-job-to-do-update-engineer.php?id=<?php echo $record['id_job_update'];?>"><span class="glyphicon glyphicon-eye-open" title="Detail"></a> &nbsp;&nbsp;<a href="edit-job-to-do-update-engineer.php?id=<?php echo $record['id_job_update'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;</td>
						    </tr>
<?php
}
?>					    							
