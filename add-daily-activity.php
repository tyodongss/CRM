      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="col-md-6">
              <form data-toggle="validator" role="form" action="process-daily-activity.php" method="post">
              <input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
				...
				<div class="form-group">
					<label>Customer / Department</label><br>
				...
				<div class="form-group">
					<label>Complained / Report by</label>
					<input class="form-control" name="name_complain">
                </div>
				
				<div class="form-group">
					<label>User / PIC</label>
					<input class="form-control" name="name_pic">
                </div>
				...
				<div class="form-group">
					<label>Problem</label>
					<input class="form-control" name="problem" required>
                </div>
				
				<div class="form-group">
					<label>Action</label>
					<input class="form-control" name="action" required>
                </div>				
