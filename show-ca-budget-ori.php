...
?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-ca-budget.php?id=<?php echo $record['id_ca_budget'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-ca-budget.php?id=<?php echo $record['id_ca_budget'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;</td>
...
?>
							<td data-field="itemid" data-sortable="true"><?php echo $no=$no+1;?></td>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-ca-budget.php?id=<?php echo $ticket_close['id_ca_budget'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-ca-budget.php?id=<?php echo $ticket_close['id_ca_budget'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;</td>
