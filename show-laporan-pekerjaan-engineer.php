    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Pekerjaan Engineer</li>
            </ol>
        </div><!--/.row-->
        
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan Pekerjaan Engineer</h1>
            </div>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <!--<div class="panel-heading">Pekerjaan Engineer</div>-->
                      ...
                      <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-pekerjaan-engineer.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-pekerjaan-engineer.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
