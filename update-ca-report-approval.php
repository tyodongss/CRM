...
$query = "update ca_request set status_ca_report_approval='$status_ca_report_approval', supervisor_name='$nama_engineer', status_ca_report_approval_manager='Not Approved', updated_at=NOW() where id_ca_request='$id'"; 
$hasil = mysql_query($query);

$to = 'marky@satnetcom.com,rosmauli@satnetcom.com,kusniyah@satnetcom.com';

$title = 'New CA Report Approval for'."\r".$nama_engineer1;
...
if($query){ 
  echo "<meta http-equiv=\"refresh\" content=\"1;show-ca-report-approval.php\">";
}else{
