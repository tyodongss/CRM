...
<?php include "menu-user.php" ?>
	...
	<div class="row">
		<div class="col-lg-12">
			<center><h1 class="page-header">Laporan Terminasi Customer</h1></center>
			
			<?php
			include "koneksi.php";
			$xls_filename = 'export-laporan-customer'.date('Y-m-d').'.xls'; // Define Excel (.xls) file name
			$tgl=$_POST['date'];
			$tgl_awal5 =$_POST['tgl_awal5'];
			$tgl_akhir5 = $_POST['tgl_akhir5'];

                        ?>
      <center><h5>Periode tanggal <b><?php echo $tgl_awal5;?></b> sampai <b><?php echo $tgl_akhir5;?></b></h5></center>
      <?php
			...
			<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="false" data-show-toggle="false" data-show-columns="false" data-search="false" data-select-item-name="toolbar1" data-pagination="false" >
						    ...
						    <tr>
						        ...
						        <th data-field="nama_service" data-sortable="true">Service</th>
								<th data-field="nama_bandwidth_down" data-sortable="true">Bandwidth Down</th>
								<th data-field="nama_bandwidth_up" data-sortable="true">Bandwidth Up</th>
...
?>
						   <tr>
						        ...
						        <td data-field="nama_service" data-sortable="true"><?php echo $record['nama_service'];?></td>
								<td data-field="nama_bandwidth_down" data-sortable="true"><?php echo $record['nama_bandwidth_down'];?></td>
								<td data-field="nama_bandwidth_up" data-sortable="true"><?php echo $record['nama_bandwidth_up'];?></td>
