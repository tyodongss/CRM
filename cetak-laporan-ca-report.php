...
<?php include "menu-user.php" ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <center><h1 class="page-header">Laporan CA Report</h1></center>
            <?php
            include "koneksi.php";

            $id_ca_request = $_POST['id_ca_request'];
            
                if ($id_ca_request="$id_ca_request"){                
				
				 $sql = "SELECT ca_report.id_ca_report, ca_request.judul_ca, ca_report.id_engineer, ca_report.id_ca_kategori, ca_report.id_ca_request, engineer.nama_engineer, ca_kategori.nama_ca_kategori, ca_report.tgl_report, ca_report.status_ca_report, ca_report.jumlah, ca_report.keterangan, ca_report.note_asli, ca_request.id_ca_request
					...
					AND ca_report.id_ca_request = '$id_ca_request'
...
<?php
			include "koneksi.php";
			$id_ca_request = $_POST['id_ca_request'];
            $query = "SELECT SUM(jumlah) as jumlah_ca_report FROM ca_report WHERE ca_report.id_ca_request = '$id_ca_request'";
			$hasil2 = mysql_query($query);
			$query2 = "SELECT jumlah from ca_request where ca_request.id_ca_request = '$id_ca_request'";            
