...
$sql = "select * from type order by name_type ASC";
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="add-type.php" class="btn btn-primary btn-md">Add New Type</a></div>
...
?>
						    <tr>
								...
								<td data-field="name_type" data-sortable="true"><?php echo $record['name_type'];?></td>
						       	<td data-field="action" data-sortable="true"><a href="edit-type.php?id=<?php echo $record['id_type'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a></td>
						    </tr>
<?php
}
?>					    							
