...
<?php include "menu-user.php" ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    $sql = "SELECT daily_activity.id_daily_activity, engineer.id_engineer, engineer.name_engineer, support_parts.id_support_parts, support_parts.name_support_parts, daily_activity.activity, customer.id_customer, customer.name_customer, daily_activity.start_time, daily_activity.end_time, daily_activity.remark, daily_activity.created_at, daily_activity.updated_at, daily_activity.deleted_at
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading"><a href="add-daily-activity-engineer.php" class="btn btn-primary btn-md">Add New Daily Activity</a></div>
...
?>
				<tr>
					...
					<td data-field="action" data-sortable="true"><a href="detail-daily-activity-engineer.php?id=<?php echo $record['id_daily_activity'];?>"><span class="glyphicon glyphicon-eye-open" title="Detail"></a> &nbsp;&nbsp;<a href="edit-daily-activity-engineer.php?id=<?php echo $record['id_daily_activity'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a></td>   
                </tr>
<?php
}}
?>                            
