    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">History IT Outsource</li>
            </ol>
        </div><!--/.row-->
        
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">History IT Outsource</h1>
            </div>
        </div><!--/.row-->
...
$sql = "select it_outsource.id_it_outsource, it_outsource.tipe_pekerjaan, it_outsource.id_engineer, it_outsource.datetime_start, it_outsource.datetime_end,  it_outsource.priority_pekerjaan,  customer.nama,  engineer.nama_engineer, it_outsource.deleted_at, timediff(it_outsource.datetime_end, it_outsource.datetime_start) as Duration from it_outsource,customer,engineer where engineer.id_engineer = it_outsource.id_engineer and customer.id_customer=it_outsource.id_customer and it_outsource.deleted_at is not NULL and it_outsource.id_engineer='$id' order by id_it_outsource desc";
...
?>
                           <tr>
                                ...
                                <td data-field="action" data-sortable="true"><a href="detail-it-outsource-support.php?id=<?php echo $record['id_it_outsource'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;</td>
                            </tr>
<?php
}}
?>                                                  
