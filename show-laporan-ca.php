...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan CA Request</h1>
            </div>
        </div><!--/.row-->
                        ...
                        <div class="col-md-6">
                            ...
                            <form id="someForm2" action="" method="POST">
								...
								<div class="form-group">
									...
									<select class="form-control" name="judul_ca_budget" required>
									<option>---- Pilih Budget ----</option>
									<?php
									include "koneksi.php";
									$sql = mysql_query("SELECT * FROM ca_budget order by judul_ca_budget asc");
									if(mysql_num_rows($sql) != 0){
									while($data = mysql_fetch_assoc($sql)){
									echo '<option value="'.$data['judul_ca_budget'].'">'.$data['judul_ca_budget'].'</option>';
									}
									}
									?>
									</select>
								<div class="help-block with-errors"></div>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-ca.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-ca.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
