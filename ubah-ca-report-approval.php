...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Ubah CA Report Approval Supervisor</h1>
			</div>
		</div><!--/.row-->
<?php 
include "koneksi.php"; 
$id=$_GET['id']; 
$query=mysql_query("select ca_request.judul_ca, ca_request.jumlah, ca_request.jumlah_sisa_ca, ca_request.id_engineer, engineer.nama_engineer, ca_request.status_ca_report_approval from ca_request, engineer where ca_request.id_engineer=engineer.id_engineer and id_ca_request='$id'"); 
?> 
<?php 
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="update-ca-report-approval.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
								...
								<div class="form-group">
                                  <label>Status CA Report Approval</label>
                                  <select class = "form-control" name="status_ca_report_approval" required>
                                  <option selected value="<?php echo $row['status_ca_report_approval'];?>"><?php echo $row['status_ca_report_approval'];?></option>
