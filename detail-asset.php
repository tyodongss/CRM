				...
				<div class="panel panel-default">
						<table class="table table-striped">
								  <tbody>
									...
									<tr>									  
									  <td width="40%"><b>Owner Asset</b></td>
									...
									<tr>									  
									  <td width="40%"><b>Status Asset</b></td>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
								<form role="form" action="show-asset.php">
