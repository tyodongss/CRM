...
$sql = "select it_outsource.id_it_outsource, it_outsource.tipe_pekerjaan, it_outsource.datetime_start, it_outsource.datetime_end,  it_outsource.priority_pekerjaan,  customer.nama, it_outsource.deleted_at, timediff(it_outsource.datetime_end, it_outsource.datetime_start) as Duration from it_outsource,customer where customer.id_customer=it_outsource.id_customer and it_outsource.deleted_at is NULL order by id_it_outsource desc";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><a href="tambah-it-outsource.php" class="btn btn-primary btn-md">Tambah IT Outsource</a></div>
...
?>
                           <tr>
                                ...
                                <td data-field="action" data-sortable="true"><a href="detail-it-outsource.php?id=<?php echo $record['id_it_outsource'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;<a href="ubah-it-outsource.php?id=<?php echo $record['id_it_outsource'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a></td>
                            </tr>
<?php
}
?>                                                  
