			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="update-vendor.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
                            <input type="hidden" name="id" value="<?php echo $id;?>"/>
								<div class="form-group">
									<label>Nama Vendor</label>
									<input class="form-control" name="name_vendor" value="<?php echo $row['name_vendor'];?>">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="handphone" value="<?php echo $row['handphone'];?>">
								</div>
								...
								<a href="../show-vendor.php" class="btn btn-default">Back</a>
<?php
}
?>	
							</div>
