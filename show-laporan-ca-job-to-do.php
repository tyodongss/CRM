    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">CA Job to Do</li>
            </ol>
        </div><!--/.row-->
        
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan CA Job to Do</h1>
            </div>
        </div><!--/.row-->
                        ...
                        <div class="col-md-6">
                            ...
                            <form id="someForm2" action="" method="POST">
								...
								<div class="form-group">
									...
									<select class="form-control" name="nama_job_to_do" required>
									...
									echo '<option value="'.$data['nama_job_to_do'].'">'.$data['nama_job_to_do'].'</option>';
									}
									}
									?>
									</select>
								<div class="help-block with-errors"></div>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-ca-job-to-do.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-ca-job-to-do.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
