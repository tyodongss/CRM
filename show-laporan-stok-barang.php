...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Laporan Stok Barang</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="cetak-laporan-stok-barang.php" method="post">
...
<div class="form-group">
                                    ...
                                    <?php
                                    include "koneksi.php";
                                    $sql = mysql_query("SELECT * FROM barang group by nama_barang asc");
