...
<?php include "menu-user.php" ?>
    ...
    <div class="row">
      ...
      <?php
            ...
            $sql = "SELECT it_outsource.id_it_outsource, it_outsource.nama_user, it_outsource.complain_via, it_outsource.tipe_pekerjaan, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.keterangan_pekerjaan, it_outsource.created_at, it_outsource.updated_at, it_outsource.deleted_at, customer.nama, customer.id_customer, engineer.nama_engineer, detail_pekerjaan.nama_detail_pekerjaan,timediff(datetime_end,datetime_start) as duration FROM it_outsource, customer, engineer, detail_pekerjaan WHERE customer.id_customer = it_outsource.id_customer AND engineer.id_engineer = it_outsource.id_engineer AND detail_pekerjaan.id_detail_pekerjaan = it_outsource.id_detail_pekerjaan AND datetime_start between '$tgl_awal' and '$tgl_akhir' AND customer.id_customer =  '22' order by id_it_outsource desc";

            } else {
            $sql = "SELECT it_outsource.id_it_outsource, it_outsource.nama_user, it_outsource.complain_via, it_outsource.tipe_pekerjaan, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.keterangan_pekerjaan, it_outsource.created_at, it_outsource.updated_at, it_outsource.deleted_at, customer.nama, customer.id_customer, engineer.nama_engineer, detail_pekerjaan.nama_detail_pekerjaan,timediff(datetime_end,datetime_start) as duration FROM it_outsource, customer, engineer, detail_pekerjaan WHERE customer.id_customer = it_outsource.id_customer AND engineer.id_engineer = it_outsource.id_engineer AND detail_pekerjaan.id_detail_pekerjaan = it_outsource.id_detail_pekerjaan AND datetime_start='$tgl' customer.id_customer =  '22' order by id_it_outsource desc";
...
?>  
      ...
      if ($tgl==""){
      $query = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.nama_user, it_outsource.complain_via, customer.id_customer, complain_via, COUNT( * ) AS total_complain FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' AND customer.id_customer =  '22' GROUP BY complain_via");
      ...
      <?php
      if ($tgl==""){
      $query2 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.nama_user, it_outsource.complain_via, customer.id_customer, it_outsource.id_detail_pekerjaan, nama_detail_pekerjaan, COUNT( * ) AS total_detail FROM it_outsource, customer, detail_pekerjaan WHERE it_outsource.id_customer = customer.id_customer AND it_outsource.id_detail_pekerjaan = detail_pekerjaan.id_detail_pekerjaan AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' AND customer.id_customer =  '22' GROUP BY nama_detail_pekerjaan");
      }  
      ...
      <table class="table"> 
       ...
       <?php
       $query3 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 1jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) < '01:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
       <br>
      <table class="table"> 
              <thead>
       ...
       <?php
       $query4 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 1_2jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) between '01:00:00' AND '02:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
      ...
      <table class="table"> 
          ...
          <?php
       $query5 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 2_4jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) between '02:01:00' AND '04:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
      ...
      <table class="table"> 
          ...
          <?php
       $query6 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 4_8jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) between '04:01:00' AND '08:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
      ...
      <table class="table"> 
          ...
          <?php
       $query7 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 8_16jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) between '08:01:00' AND '16:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
      ...
      <table class="table"> 
          ...
          <?php
       $query7 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 16_24jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) between '16:01:00' AND '24:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
      ...
      <table class="table"> 
          ...
          <?php
       $query8 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 24_48jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) between '24:01:00' AND '48:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
      ...
      <table class="table"> 
          ...
          <?php
       $query9 = mysql_query("SELECT it_outsource.id_it_outsource, it_outsource.id_customer, it_outsource.nama_user, it_outsource.complain_via, it_outsource.datetime_start, it_outsource.datetime_end, it_outsource.tipe_pekerjaan, it_outsource.priority_pekerjaan, it_outsource.scope_pekerjaan, it_outsource.id_detail_pekerjaan, it_outsource.keterangan_pekerjaan, customer.nama, TIMEDIFF( datetime_end, datetime_start ) AS duration, nama, count(*) as 48jam FROM it_outsource, customer WHERE it_outsource.id_customer = customer.id_customer AND nama='Prasmanindo Boga Utama, PT - Balikpapan' AND TIMEDIFF(datetime_end, datetime_start) > '48:00:00' AND datetime_start BETWEEN  '$tgl_awal' AND  '$tgl_akhir' group by nama");
       ?>
