...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		$sql = "select customer_complain.id_customer_complain,customer_complain.swos,customer_complain.id_customer,customer.nama,customer_complain.status_charge,customer_complain.datetime_start,customer_complain.datetime_end,customer_complain.status_cust_complain from customer_complain,customer where customer.id_customer=customer_complain.id_customer order by id_customer_complain DESC";
