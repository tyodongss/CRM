...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tambah CA Budget</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form data-toggle="validator" role="form" action="proses-ca-budget.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">

								<div class="form-group">
									<label>Judul CA Budget</label>
									<input class="form-control" name="judul_ca_budget" value="">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="jumlah_awal" value="" required>
                                <div class="help-block with-errors"></div>
								</div>
								
								<div class="form-group">
									<label>Jumlah Sisa</label> 
									<input class="form-control" name="jumlah_sisa" value="" required>
                                <div class="help-block with-errors"></div>
								</div>
