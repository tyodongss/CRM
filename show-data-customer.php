...
$sql = "select customer.id_customer, customer.nama, customer.contact_person_1, customer.contact_person_2, customer.hp_1, customer.hp_2, customer.email_1, customer.email_2, customer.deleted_at, service.nama_service from customer, service where service.id_service=customer.id_service and deleted_at is NULL order by nama asc";
...
?>
						   <tr>
						    ...
						    <td data-field="action" data-sortable="true"><a href="detail-data-customer.php?id=<?php echo $record['id_customer'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;</td>
						    </tr>
<?php
}
?>					    							
