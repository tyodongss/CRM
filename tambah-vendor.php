			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form data-toggle="validator" role="form" action="proses-vendor.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">

								<div class="form-group">
									<label>Nama Vendor</label>
									<input class="form-control" name="nama_vendor" value="" required>
								...
								<div class="form-group">
									...
									<input class="form-control" name="contact_person" value="" maxlength="25" required>
                                                                <div class="help-block with-errors"></div>
								</div>
