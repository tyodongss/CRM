...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan Customer Complain</h1>
            </div>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <!--<div class="panel-heading">Customer Complain</div>-->
                      ...
                      <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-customer-complain.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-customer-complain.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
