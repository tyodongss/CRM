...
$sql = "select * from model order by name_model ASC";
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="add-model.php" class="btn btn-primary btn-md">Add New Model</a></div>
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="yes" >
						    <thead>
						    <tr>
							    <th data-field="itemid" data-sortable="true" width="10">No</th>
...
?>
						    <tr>
								...
								<td data-field="name_model" data-sortable="true"><?php echo $record['name_model'];?></td>
						       	<td data-field="action" data-sortable="true"><a href="edit-model.php?id=<?php echo $record['id_model'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a></td>
						    </tr>
<?php
}
?>					    							
