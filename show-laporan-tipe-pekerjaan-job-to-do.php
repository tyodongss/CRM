        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Berdasarkan Tipe Pekerjaan</div>
							...
							<div class="form-group">
                                ...
                                <option>Other</option>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-tipe-pekerjaan-job-to-do.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-tipe-pekerjaan-job-to-do.php";
                                            form.submit();
                                    }
                                    </script>                             
                            </div>
