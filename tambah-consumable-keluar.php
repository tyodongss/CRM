...
<?php include "menu-user.php" ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Tambah Consumable Keluar</h1>
      </div>
    </div><!--/.row-->
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="col-md-6">
              <form data-toggle="validator" role="form" action="proses-consumable-keluar.php" method="post">
              <input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">

                <div class="form-group">
                  <label>Nama Consumable</label>
                  <select class="form-control" name="id_consumable" required>
                  <option>---- Pilih Consumable ----</option>
                  <?php
                  include "koneksi.php";
                  $sql = mysql_query("SELECT * FROM consumable where jumlah_stok!='0' order by nama_consumable asc");
                ...
                <div class="form-group">
                  ...
                  <?php
                    ...
                    $today = date("Y-m-d");
                  ?>
                  <input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="tgl_keluar" value="<?php echo $today; ?>" readonly>
                </div>
                
                <div class="form-group">
                  <label>Jumlah Keluar</label>
                  <input class="form-control" name="jumlah_keluar" value="" maxlength="20">
                </div>
                ...
                <div class="form-group">
                  <label>SWOS</label>
                  <input class="form-control" name="swos" maxlength="5" value="">
                </div>             
