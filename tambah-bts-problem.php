...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tambah BTS Problem</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form data-toggle="validator" role="form" action="proses-bts-problem.php" method="post">
							<input type="hidden" name="_token" value="L8C5ujpOh4UEsaNko2Y3pkuzP714OtRymsXPqrNJ">
								...
								<div class="form-group">
									...
									<select class="form-control" name="id_device_bts" required>
								...
								<div class="form-group">
                                    <label>Status</label>
                                    <select class = "form-control" name="status_bts_problem" required>
