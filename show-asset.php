...
$sql = "select asset.id_asset,item.code_item,item.nama_item,asset.serial_number,asset.po_number,asset.id_lokasi,lokasi.nama_lokasi from asset,item,lokasi where item.code_item=asset.code_item and lokasi.id_lokasi=asset.id_lokasi order by id_asset DESC";
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="tambah-asset.php" class="btn btn-primary btn-md">Tambah Asset</a></div>
...
?>
						    <tr>
								...
								<td data-field="lokasi" data-sortable="true"><?php echo $record['nama_lokasi'];?></td>
						       	<td data-field="action" data-sortable="true"><a href="detail-asset.php?id=<?php echo $record['id_asset'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-asset.php?id=<?php echo $record['id_asset'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;<a href="all-detail-asset-update.php?id=<?php echo $record['id_asset'];?>"><span class="glyphicon glyphicon-tasks" title="All Detail Asset"></a></td>
						    </tr>
<?php
}
?>					    							
