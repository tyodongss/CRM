...
<?php include "menu-user.php" ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">BACKBONE</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="tambah-backbone.php" class="btn btn-primary btn-md">Tambah Backbone</a></div>
...
?>
						        ...
						        <td data-field="action" data-sortable="true"><a href="detail-backbone.php?id=<?php echo $record['id_backbone'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a> &nbsp;&nbsp;<a href="ubah-backbone.php?id=<?php echo $record['id_backbone'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;</td>
