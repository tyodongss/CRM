...
<?php include "menu-user.php" ?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Laporan IT Outsource</h1>
            </div>
        </div><!--/.row-->
         ...
         <div class="row">
                    ...
                    <span class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                                    ...
                                    function askForLihat() {
                                            form.action="cetak-laporan-it-outsource-pbu.php";
                                            form.submit();
                                    }
                                    function askForDownload() {
                                            form.action="export-laporan-it-outsource-pbu.php";
                                            form.submit();
                                    }
                                    </script>
                            ...
                            <!--form role="form" action="export-laporan-barang-masuk.php" method="post">
            ...
            $today = date("Y-m-d");
            ?>
                                    <input class="form-control" name="tgl_awal" value="<?php print date('Y-m-d G:i') ?>" type="datetime">
                                </div>
                                
                                <div class="form-group">
                                    <label>Tanggal Akhir</label>
                                    <input class="form-control" name="tgl_akhir" value="<?php print date('Y-m-d G:i') ?>" type="datetime">
                                </div>                              
                                <a href="cetak-laporan-barang-masuk.php" class="btn btn-info" role="button">Lihat</a>                           
