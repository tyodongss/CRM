        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><a href="add-job-to-do.php" class="btn btn-primary btn-md">Add New Job To Do</a></div>
...
?>
                           <tr>
								...
								<td data-field="action" data-sortable="true"><a href="detail-job-to-do.php?id=<?php echo $record['id_job'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;<a href="edit-job-to-do.php?id=<?php echo $record['id_job'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a>&nbsp;&nbsp;<a href="history-job-to-do-update.php?id=<?php echo $record['id_job'];?>"><span class="glyphicon glyphicon-tasks" title="Detail Job To Do"></a>&nbsp;&nbsp;<a href="upload.php?id=<?php echo $record['id_job'];?>"><span class="glyphicon glyphicon-circle-arrow-up" title="Upload File"></a></td>
...
?>
							<tr>
								...
								<td data-field="action" data-sortable="true"><a href="detail-job-to-do.php?id=<?php echo $ticket_close['id_job'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;<a href="edit-job-to-do.php?id=<?php echo $ticket_close['id_job'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a>&nbsp;&nbsp;<a href="history-job-to-do-update.php?id=<?php echo $ticket_close['id_job'];?>"><span class="glyphicon glyphicon-tasks" title="Detail Job To Do"></a>&nbsp;&nbsp;<a href="upload.php?id=<?php echo $ticket_close['id_job'];?>"><span class="glyphicon glyphicon-circle-arrow-up" title="Upload File"></a></td>
                            </tr>
<?php
}
?>					    							
...
?>
							<tr>							
								...
								<td data-field="action" data-sortable="true"><a href="detail-job-to-do.php?id=<?php echo $ticket_monitoring2['id_job'];?>"><span class="glyphicon glyphicon-eye-open" title="Details"></a>&nbsp;&nbsp;<a href="edit-job-to-do.php?id=<?php echo $ticket_monitoring2['id_job'];?>"><span class="glyphicon glyphicon-pencil" title="Edit"></a>&nbsp;&nbsp;<a href="history-job-to-do-update.php?id=<?php echo $ticket_monitoring2['id_job'];?>"><span class="glyphicon glyphicon-tasks" title="Detail Job To Do"></a>&nbsp;&nbsp;<a href="upload.php?id=<?php echo $ticket_monitoring2['id_job'];?>"><span class="glyphicon glyphicon-circle-arrow-up" title="Upload File"></a></td>                            </tr>
							</tr>
<?php
}
?>					    							
