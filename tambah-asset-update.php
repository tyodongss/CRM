...
<?php include "menu-user.php" ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Tambah Asset Update</h1>
      </div>
    </div><!--/.row-->
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <form data-toggle="validator" role="form" action="proses-asset-update.php" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" data-provide="datepicker" data-date-format="yyyy/mm/dd" name="tgl_asset_update" value="">
                <div class="help-block with-errors"></div>
            </div>
            ...
            <div class="form-group">
              ...
              <select class = "form-control" name="keterangan" id="dbType">
                <option>---- Pilih Keterangan ----</option>
                  <option value="asset masuk">asset masuk</option>
                  <option value="asset keluar">asset keluar</option>
                  <option value="asset dismantle">asset dismantle</option>
                  <option value="asset rma">asset rma</option>
              </select>
            </div>
